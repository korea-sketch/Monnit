...
console.log('\n■ 오검출 방지 — 다른 뜻으로 쓰인 말은 잡지 않는다 (2026-09-19)');
[['fac', '온도 관리에 유리한 방법이 있을까 해서요', ''], ['fac', '조립식 건물이에요', ''], ['fac', '도장 찍어야 해서 급해요', ''],
 ['fac', '전화 라인이 하나예요', ''], ['fac', '고무적인 결과였어요', ''],
 ['con', '주말에 납품이 있어서', ''], ['con', '휴일 근무가 많아요', ''], ['con', '덥석 잡았어요', ''],
 ['con', '수명이 다한 배터리', ''], ['con', '통합이 어려워요', ''],
 /* 같은 낱말이라도 복합어·현장 문맥이면 잡는다 */
 ['fac', '조립 라인이에요', 'factory'], ['fac', '도장 공장입니다', 'factory'], ['fac', '유리 공장', 'factory'],
 ['con', '주말에 사람이 없어서', 'security'], ['con', '퇴근 후에 비어 있어요', 'security'],
 ['con', '통합 관제 하고 싶어요', 'control'], ['con', '라인 정지가 잦아요', 'equip']
].forEach(([a, i, w]) => T(a, i, w));
