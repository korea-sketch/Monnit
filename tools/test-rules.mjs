...
H('규칙 2 — 응대 메일은 백서·컨설팅만');
{
  ...
  /* 2026-09-08 부터 알리미 4종만 _alarmmail.mjs 로 응대 메일을 보낸다 — 예전 범용 _reply.mjs 는 쓰지 않는다 */
  ok('lead.mjs 는 범용 응대 메일(_reply.mjs)을 쓰지 않는다', !/from '\.\/_reply/.test(leadSrc) && /_alarmmail\.mjs/.test(leadSrc));
